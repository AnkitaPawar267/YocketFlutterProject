class RestaurantResponsePojo {
  //String nextPageToken;
  List<Results> results;

//  RestaurantResponsePojo({this.nextPageToken, this.results});
  RestaurantResponsePojo({this.results});

  RestaurantResponsePojo.fromJson(Map<String, dynamic> json) {
